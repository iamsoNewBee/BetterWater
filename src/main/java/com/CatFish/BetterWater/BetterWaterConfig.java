...
public class BetterWaterConfig {
    ...
    public static int lavaBodyThreshold = 10;            // 岩浆湖通常较小
    public static int lavaSearchRadius = 8;
    public static int lavaMaxVerticalRange = 2;          // 允许垂直范围稍大（岩浆湖常多层）
    public static int lavaMaxBlocksToCheck = 500;
    public static int lavaProcessingDelayTicks = 1;
    public static boolean lavaAlwaysCheckAirBlocks = true;

    // 岩浆维度/群系限制（默认允许下界，禁用主世界/末地）
    public static int[] lavaValidDims = {-1};             // 下界
    public static int[] lavaBannedDims = {0, 1};          // 主世界、末地默认禁止
    public static int[] lavaOceanDims = {};               // 无强制维度
    ...
    public static int lavaLower = 0;                       // 岩浆湖常见Y范围
    public static int lavaUpper = 30;
...
// 水域检测参数
            ...
            maxVerticalRange = config.getInt("maxVerticalRange", Configuration.CATEGORY_GENERAL, 1, 1, 10, "Vertical search range for water bodies");
...
// 群系限制参数（水）
            ...
            lavaMaxVerticalRange = config.getInt("lavaMaxVerticalRange", "lava", 2, 1, 10, "Vertical search range for lava");
            lavaMaxBlocksToCheck = config.getInt("lavaMaxBlocksToCheck", "lava", 500, 10, 10000, "Max blocks to check for lava");
            lavaProcessingDelayTicks = config.getInt("lavaProcessingDelayTicks", "lava", 1, 0, 20, "Delay before processing lava block break");
